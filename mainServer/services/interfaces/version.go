...
type VersionService interface {
	...
	// GetOldVersion does the same as GetVersion, but with a specific history/commit ID
	// Doesn't necessarily have to be an old version, most recent commit ID can also be specified
	GetOldVersion(article int64, version int64, commit [20]byte) (models.Version, error)
